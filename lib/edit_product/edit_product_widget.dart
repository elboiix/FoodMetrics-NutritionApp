...
/// genera un formulario para añadir un producto donde ponga nombre del
/// producto, codigo de barras, calorias por 100g, proteinas, grasas,
/// carbohidratos
///
class EditProductWidget extends StatefulWidget {
  ...
  final ProductsRow? productToEdit;
...
class _EditProductWidgetState extends State<EditProductWidget>
  ...
  void initState() {
    ...
    _model.textController4 ??= TextEditingController(
        text: widget.productToEdit?.caloriesPer100g?.toString());
    _model.textFieldFocusNode4 ??= FocusNode();

    _model.textController5 ??= TextEditingController(
        text: widget.productToEdit?.proteinPer100g?.toString());
    _model.textFieldFocusNode5 ??= FocusNode();

    _model.textController6 ??= TextEditingController(
        text: widget.productToEdit?.fatsPer100g?.toString());
    _model.textFieldFocusNode6 ??= FocusNode();

    _model.textController7 ??= TextEditingController(
        text: widget.productToEdit?.carbsPer100g?.toString());

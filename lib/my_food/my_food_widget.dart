...
import '/components/add_food_popup_widget.dart';
import '/components/navbar_widget.dart';
import '/components/remove_product_popup_widget.dart';
...
import 'my_food_model.dart';
export 'my_food_model.dart';
...
class MyFoodWidget extends StatefulWidget {
  ...
  static String routeName = 'MyFood';
  static String routePath = '/myFood';
...
class _MyFoodWidgetState extends State<MyFoodWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MyFoodModel());
          ...
          title: Row(
            ...
            children: [
              Column(
                ...
                children: [
                  Text(
                    widget.mealType != 'None' ? 'Diary > My Food' : 'My Food',

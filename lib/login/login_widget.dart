                      ...
                      Align(
                        ...
                        child: Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              20.0, 0.0, 0.0, 0.0),
                          child: Text(
                            'Log in to track your nutrition today',
                      ...
                      Align(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            ...
                            _model.validationOutput = true;
                            if (_model.formKey.currentState == null ||
                                !_model.formKey.currentState!.validate()) {
                              _model.validationOutput = false;
                            }
                            _shouldSetState = true;
                            if (_model.validationOutput == true) {
                              if (_model
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                  content: Text(
                                    'Enter a valid email address to receive the password reset email.',
                                    style: TextStyle(
                                      color: Colors.white,
                                    ),
                                  ),

  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          case DailyLogsRow:
            return DailyLogsRow(data);
          case MealEntriesRow:
            return MealEntriesRow(data);
          case ProductsRow:
          ...
          case VwDashboardDisplayRow:
            return VwDashboardDisplayRow(data);
          case VwDiaryDisplayRow:
            return VwDiaryDisplayRow(data);
          default:
            return null;
        }

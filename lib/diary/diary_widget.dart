...
import '/components/remove_product_diary_popup_widget.dart';
...
/// haz una pantalla de diario de comida, pon 5 tarjetas con cada una un
/// titulo, cada tarjeta va a tener informacion, carbohidratos, proteinas,
/// grasas y calorias y habra un boton que ponga añadir alimento
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          ...
          child: Stack(
            children: [
              FutureBuilder<List<VwDiaryDisplayRow>>(
                future: VwDiaryDisplayTable().queryRows(
                  queryFn: (q) => q
                      .eqOrNull(
                        'user_id',
                        currentUserUid,
                ...
                builder: (context, snapshot) {
                  ...
                  List<VwDiaryDisplayRow> containerVwDiaryDisplayRowList =
                      snapshot.data!;
                                                ...
                                                children: [
                                                  TextSpan(
                                                    text:
                                                      ...
                                                      functions
                                                          .sumMacrosForMeal(
                                                              containerVwDiaryDisplayRowList
                                                                  .where((e) =>
                                                                      e.mealType ==
                                                                      'Breakfast')
                                                                  .toList(),
                                                                          ...
                                                                          children: [
                                                                            TextSpan(
                                                                              text: valueOrDefault<String>(
                                                                                breakfastItemsItem.amountGrams,
                                                                                'amount_display',
                                                                              ),
                                        ...
                                        Builder(
                                          builder: (context) {
                                            ...
                                            return ListView.builder(
                                              ...
                                              itemBuilder:
                                                  (context, dinnerItemsIndex) {
                                                final dinnerItemsItem =
                                                    dinnerItems[
                                                        dinnerItemsIndex];
                                                return Padding(
                                                  padding: EdgeInsetsDirectional
                                        ...
                                        Builder(
                                          builder: (context) {
                                            ...
                                            return ListView.builder(
                                              ...
                                              itemBuilder:
                                                  (context, snackItemsIndex) {
                                                final snackItemsItem =
                                                    snackItems[snackItemsIndex];
                                                return Padding(
                                                  padding: EdgeInsetsDirectional
                                                      .fromSTEB(
                                                          0.0, 0.0, 0.0, 8.0),
                                        ...
                                        Builder(
                                          builder: (context) {
                                            ...
                                            return ListView.builder(
                                              ...
                                              shrinkWrap: true,
                                              scrollDirection: Axis.vertical,
                                              itemCount: supperItems.length,
                                              itemBuilder:
                                                  (context, supperItemsIndex) {
                                                final supperItemsItem =
                                                    supperItems[
                                                        supperItemsIndex];
                                                return Padding(
                                                  padding: EdgeInsetsDirectional
